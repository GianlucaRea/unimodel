 ...
 * </p>
 * <ul>
 *   <li>{@link it.univaq.disim.unimodel_webapp.impl.NamedImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NamedImpl extends MinimalEObjectImpl.Container implements Named {
	...
	protected EClass eStaticClass() {
		return Unimodel_webappPackage.Literals.NAMED;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Unimodel_webappPackage.NAMED__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Unimodel_webappPackage.NAMED__NAME:
			return getName();
		}
