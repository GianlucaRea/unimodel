...
/**
 * This is the item provider adapter for a {@link it.univaq.disim.unimodel.h4model.Room} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoomItemProvider extends NamedItemProvider {
	/**
	...
	protected void addDimensionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Room_dimension_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Room_dimension_feature", "_UI_Room_type"),
						H4modelPackage.Literals.ROOM__DIMENSION, true, false, false,
	...
	protected void addSocketsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Room_sockets_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Room_sockets_feature", "_UI_Room_type"),
						H4modelPackage.Literals.ROOM__SOCKETS, true, false, false,
	...
	public void notifyChanged(Notification notification) {
		...
		case H4modelPackage.ROOM__DIMENSION:
		case H4modelPackage.ROOM__SOCKETS:
