...
/**
 * This is the item provider adapter for a {@link it.univaq.disim.unimodel.h4model.Office} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OfficeItemProvider extends NamedItemProvider {
	/**
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Office_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Office_type_feature", "_UI_Office_type"),
						H4modelPackage.Literals.OFFICE__TYPE, true, false, false,
	...
	protected void addCapacityPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Office_capacity_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Office_capacity_feature",
								"_UI_Office_type"),
						H4modelPackage.Literals.OFFICE__CAPACITY, true, false, false,
	...
	protected void addOffice_addressPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Office_office_address_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Office_office_address_feature",
								"_UI_Office_type"),
						H4modelPackage.Literals.OFFICE__OFFICE_ADDRESS, true, false, true, null, null, null));
	}
	...
	protected void addPhonePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Office_phone_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Office_phone_feature", "_UI_Office_type"),
						H4modelPackage.Literals.OFFICE__PHONE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addDimensionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Office_dimension_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Office_dimension_feature",
								"_UI_Office_type"),
						H4modelPackage.Literals.OFFICE__DIMENSION, true, false, false,
	...
	protected void addSocketsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Office_sockets_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Office_sockets_feature",
								"_UI_Office_type"),
						H4modelPackage.Literals.OFFICE__SOCKETS, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(H4modelPackage.Literals.OFFICE__PERSON_IN_OFFICE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(H4modelPackage.Literals.OFFICE__PERSON_IN_OFFICE,
				H4modelFactory.eINSTANCE.createPerson()));
	}
