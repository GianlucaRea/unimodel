...
/**
 * This is the item provider adapter for a {@link it.univaq.disim.unimodel.h4model.Library} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LibraryItemProvider extends NamedItemProvider {
	...
	protected void addWorkstationsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Library_workstations_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Library_workstations_feature",
								"_UI_Library_type"),
						H4modelPackage.Literals.LIBRARY__WORKSTATIONS, true, false, false,
	...
	protected void addComputersPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Library_computers_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Library_computers_feature",
								"_UI_Library_type"),
						H4modelPackage.Literals.LIBRARY__COMPUTERS, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(H4modelPackage.Literals.LIBRARY__BOOKS);
			childrenFeatures.add(H4modelPackage.Literals.LIBRARY__LOANS);
			childrenFeatures.add(H4modelPackage.Literals.LIBRARY__PERSON);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(H4modelPackage.Literals.LIBRARY__BOOKS, H4modelFactory.eINSTANCE.createBook()));

		newChildDescriptors.add(
				createChildParameter(H4modelPackage.Literals.LIBRARY__LOANS, H4modelFactory.eINSTANCE.createLoan()));

		newChildDescriptors.add(
				createChildParameter(H4modelPackage.Literals.LIBRARY__PERSON, H4modelFactory.eINSTANCE.createPerson()));
	}
