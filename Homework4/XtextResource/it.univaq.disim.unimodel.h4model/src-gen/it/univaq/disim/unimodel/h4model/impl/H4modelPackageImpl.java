...
import it.univaq.disim.unimodel.h4model.util.H4modelValidator;
 ...
 * @generated
 */
public class H4modelPackageImpl extends EPackageImpl implements H4modelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see it.univaq.disim.unimodel.h4model.H4modelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private H4modelPackageImpl() {
		super(eNS_URI, H4modelFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link H4modelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static H4modelPackage init() {
		if (isInited)
			return (H4modelPackage) EPackage.Registry.INSTANCE.getEPackage(H4modelPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredH4modelPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		H4modelPackageImpl theH4modelPackage = registeredH4modelPackage instanceof H4modelPackageImpl
				? (H4modelPackageImpl) registeredH4modelPackage
				: new H4modelPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theH4modelPackage.createPackageContents();

		// Initialize created meta-data
		theH4modelPackage.initializePackageContents();

		// Register package validator
		EValidator.Registry.INSTANCE.put(theH4modelPackage, new EValidator.Descriptor() {
			public EValidator getEValidator() {
				return H4modelValidator.INSTANCE;
			}
		});

		// Mark meta-data to indicate it can't be changed
		theH4modelPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(H4modelPackage.eNS_URI, theH4modelPackage);
		return theH4modelPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getFloor_Offices() {
	 ...
	 * @generated
	 */
	public EReference getFloor_Classes() {
		return (EReference) floorEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EAttribute getOffice_Phone() {
		return (EAttribute) officeEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EAttribute getOffice_Dimension() {
		return (EAttribute) officeEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EAttribute getOffice_Sockets() {
		return (EAttribute) officeEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 * @generated
	 */
	public EAttribute getClass_Dimension() {
	 ...
	 * @generated
	 */
	public EAttribute getClass_Sockets() {
	 ...
	 * @generated
	 */
	public H4modelFactory getH4modelFactory() {
		return (H4modelFactory) getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(floorEClass, FLOOR__OFFICES);
		createEReference(floorEClass, FLOOR__CLASSES);
		...
		createEAttribute(officeEClass, OFFICE__PHONE);
		createEAttribute(officeEClass, OFFICE__DIMENSION);
		createEAttribute(officeEClass, OFFICE__SOCKETS);
		...
		createEAttribute(classEClass, CLASS__DIMENSION);
		createEAttribute(classEClass, CLASS__SOCKETS);
	...
	public void initializePackageContents() {
		...
		officeEClass.getESuperTypes().add(this.getNamed());
		...
		initEAttribute(getUniversity_Chancellor(), ecorePackage.getEString(), "chancellor", null, 0, 1,
				University.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getUniversity_Description(), ecorePackage.getEString(), "description", null, 0, 1,
				University.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getUniversity_Buildings(), this.getBuilding(), null, "buildings", null, 1, -1, University.class,
		...
		initEClass(buildingEClass, Building.class, "Building", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBuilding_Description(), ecorePackage.getEString(), "description", null, 0, 1, Building.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBuilding_Address(), this.getAddress(), null, "address", null, 1, 1, Building.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBuilding_Library(), this.getLibrary(), null, "library", null, 0, 1, Building.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBuilding_Floors(), this.getFloor(), null, "floors", null, 1, -1, Building.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAddress_Street(), ecorePackage.getEString(), "street", null, 0, 1, Address.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAddress_Civic(), ecorePackage.getEString(), "civic", null, 0, 1, Address.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAddress_Id(), ecorePackage.getEInt(), "id", null, 1, 1, Address.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAddress_Phone(), ecorePackage.getEString(), "phone", null, 0, 1, Address.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(libraryEClass, Library.class, "Library", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLibrary_Workstations(), ecorePackage.getEInt(), "workstations", null, 1, 1, Library.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLibrary_Computers(), ecorePackage.getEInt(), "computers", null, 1, 1, Library.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getLibrary_Loans(), this.getLoan(), null, "loans", null, 0, -1, Library.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEReference(getLibrary_Person(), this.getPerson(), null, "person", null, 0, -1, Library.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEAttribute(getBook_Author(), ecorePackage.getEString(), "author", null, 0, 1, Book.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBook_Library(), this.getLibrary(), null, "library", null, 0, 1, Book.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEOperation(getBook__IsBookAvailable(), ecorePackage.getEBooleanObject(), "isBookAvailable", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		...
		initEReference(getLoan_Book(), this.getBook(), null, "book", null, 0, 1, Loan.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getLoan_Person(), this.getPerson(), null, "person", null, 0, 1, Loan.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(floorEClass, Floor.class, "Floor", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getFloor_Number(), ecorePackage.getEInt(), "number", null, 1, 1, Floor.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFloor_Rooms(), this.getRoom(), null, "rooms", null, 0, -1, Floor.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getFloor_Bathrooms(), ecorePackage.getEInt(), "bathrooms", null, 1, 1, Floor.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFloor_Offices(), this.getOffice(), null, "offices", null, 0, -1, Floor.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getFloor_Classes(), this.getClass_(), null, "classes", null, 0, -1, Floor.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEAttribute(getOffice_Capacity(), ecorePackage.getEInt(), "capacity", null, 1, 1, Office.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOffice_Person_in_office(), this.getPerson(), null, "person_in_office", null, 1, -1,
				Office.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOffice_Office_address(), this.getAddress(), null, "office_address", null, 1, 1, Office.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOffice_Phone(), ecorePackage.getEString(), "phone", null, 0, 1, Office.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOffice_Dimension(), ecorePackage.getEFloat(), "dimension", null, 1, 1, Office.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOffice_Sockets(), ecorePackage.getEInt(), "sockets", null, 1, 1, Office.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEOperation(getOffice__GetPersonInOffice(), ecorePackage.getEBigInteger(), "getPersonInOffice", 0, 1,
				IS_UNIQUE, IS_ORDERED);

		initEClass(classEClass, it.univaq.disim.unimodel.h4model.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getClass_Seats(), ecorePackage.getEInt(), "seats", null, 1, 1,
				it.univaq.disim.unimodel.h4model.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getClass_Blackboards(), ecorePackage.getEInt(), "blackboards", null, 1, 1,
				it.univaq.disim.unimodel.h4model.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getClass_Speakers(), ecorePackage.getEInt(), "speakers", null, 1, 1,
				it.univaq.disim.unimodel.h4model.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getClass_Computers(), ecorePackage.getEInt(), "computers", null, 1, 1,
				it.univaq.disim.unimodel.h4model.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getClass_Dimension(), ecorePackage.getEFloat(), "dimension", null, 1, 1,
				it.univaq.disim.unimodel.h4model.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getClass_Sockets(), ecorePackage.getEInt(), "sockets", null, 1, 1,
				it.univaq.disim.unimodel.h4model.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(personEClass, Person.class, "Person", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPerson_Category(), this.getCategory(), "category", null, 1, 1, Person.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPerson_Badge(), ecorePackage.getEString(), "badge", null, 0, 1, Person.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPerson_Age(), ecorePackage.getEInt(), "age", null, 1, 1, Person.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPerson_Fiscal_code(), ecorePackage.getEString(), "fiscal_code", null, 0, 1, Person.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPerson_Library(), this.getLibrary(), null, "library", null, 0, 1, Person.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getPerson_Loans(), this.getLoan(), null, "loans", null, 0, -1, Person.class, !IS_TRANSIENT,
				IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
				!IS_ORDERED);
		initEReference(getPerson_Books(), this.getBook(), null, "books", null, 0, -1, Person.class, !IS_TRANSIENT,
				IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, IS_DERIVED,
				!IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation(addressEClass, source, new String[] { "constraints", "postcode_length id_number phone_length" });
		addAnnotation(libraryEClass, source, new String[] { "constraints", "workstation_positive computers_positive" });
		addAnnotation(bookEClass, source,
				new String[] { "constraints", "quantity_positive ISBN_legth SufficientCopies" });
		addAnnotation(floorEClass, source, new String[] { "constraints", "bathroom_positive" });
		addAnnotation(roomEClass, source, new String[] { "constraints", "sockets_positive" });
		addAnnotation(officeEClass, source,
				new String[] { "constraints", "capacity_positive person_in_office_constraint" });
		addAnnotation(classEClass, source,
				new String[] { "constraints", "seats_positive blackboards_positive speakers_positive" });
		addAnnotation(personEClass, source,
				new String[] { "constraints", "age_upper_bound age_lower_bound fiscal_code_length" });
	}
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation(addressEClass, source, new String[] { "postcode_length", "self.post_code.size() = 5", "id_number",
				"self.id >= 1", "phone_length", "self.phone.size() = 10" });
		addAnnotation(libraryEClass, source, new String[] { "workstation_positive", "self.workstations >= 1",
				"computers_positive", "self.computers >= 0" });
		addAnnotation(bookEClass, source, new String[] { "quantity_positive", "self.quantity >= 0", "ISBN_legth",
				"self.ISBN.size() = 13", "SufficientCopies", "library.loans->select(book=self)->size() <= quantity" });
		addAnnotation(getBook__IsBookAvailable(), source, new String[] { "body", "loans->size() < quantity" });
		addAnnotation(getBook_Loans(), source, new String[] { "derivation", "library.loans->select(book=self)" });
		addAnnotation(floorEClass, source, new String[] { "bathroom_positive", "self.bathrooms >= 1" });
		addAnnotation(roomEClass, source, new String[] { "sockets_positive", "self.sockets >= 0" });
		addAnnotation(officeEClass, source, new String[] { "capacity_positive", "self.capacity >= 1",
				"person_in_office_constraint", "self.person_in_office->size() <= capacity" });
		addAnnotation(getOffice__GetPersonInOffice(), source, new String[] { "body", "self.person_in_office->size()" });
		addAnnotation(classEClass, source, new String[] { "seats_positive", "self.seats > 0", "blackboards_positive",
				"self.blackboards >= 0", "speakers_positive", "self.speakers >= 0" });
		addAnnotation(personEClass, source, new String[] { "age_upper_bound", "self.age >= 16", "age_lower_bound",
				"self.age <= 120", "fiscal_code_length", "self.fiscal_code.size() = 16" });
		addAnnotation(getPerson_Loans(), source, new String[] { "derivation", "library.loans->select(person=self)" });
		addAnnotation(getPerson_Books(), source, new String[] { "derivation", "loans->collect(book)" });
	}
	...
	protected void createCollectionAnnotations() {
		...
		addAnnotation(getLibrary_Books(), source, new String[] { "nullFree", "false" });
		addAnnotation(getLibrary_Loans(), source, new String[] { "nullFree", "false" });
		addAnnotation(getBook_Loans(), source, new String[] { "nullFree", "false" });
		addAnnotation(getPerson_Loans(), source, new String[] { "nullFree", "false" });
		addAnnotation(getPerson_Books(), source, new String[] { "nullFree", "false" });
	}
