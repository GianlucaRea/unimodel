 ...
 * </p>
 * <ul>
 *   <li>{@link it.univaq.disim.unimodel.h4model.impl.NamedImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NamedImpl extends MinimalEObjectImpl.Container implements Named {
	...
	protected EClass eStaticClass() {
		return H4modelPackage.Literals.NAMED;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, H4modelPackage.NAMED__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case H4modelPackage.NAMED__NAME:
			return getName();
		}
