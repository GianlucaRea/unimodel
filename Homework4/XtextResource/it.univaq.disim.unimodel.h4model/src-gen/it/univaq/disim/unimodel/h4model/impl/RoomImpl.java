 ...
 * </p>
 * <ul>
 *   <li>{@link it.univaq.disim.unimodel.h4model.impl.RoomImpl#getDimension <em>Dimension</em>}</li>
 *   <li>{@link it.univaq.disim.unimodel.h4model.impl.RoomImpl#getSockets <em>Sockets</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RoomImpl extends NamedImpl implements Room {
	...
	protected EClass eStaticClass() {
		return H4modelPackage.Literals.ROOM;
	}
	...
	public void setDimension(float newDimension) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, H4modelPackage.ROOM__DIMENSION, oldDimension,
					dimension));
	}
	...
	public void setSockets(int newSockets) {
		...
		sockets = newSockets;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, H4modelPackage.ROOM__SOCKETS, oldSockets, sockets));
	}
