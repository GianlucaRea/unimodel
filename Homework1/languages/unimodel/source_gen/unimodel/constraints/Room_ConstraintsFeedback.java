...
public final class Room_ConstraintsFeedback extends BaseFeedbackDescriptor {
  ...
  private static final FeedbackProvider<ContainmentContext> MSGPROVIDER_WhenConstraintRuleFails_nfu81n_a = new BaseMessageProvider<ContainmentContext>(new FailingRuleProblemId(Room_ConstraintRules.Rule_socket.ID_socket)) {
    @NotNull
    @Override
    public MessageProvider.Msg yieldMessage(ContainmentContext context) {
      return new MessageProvider.StringMsg("Warning: the number of sockets cannot be negative");
    }
  };
