	...
	protected void addPhonePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Address_phone_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Address_phone_feature", "_UI_Address_type"),
				 UnimodelPackage.Literals.ADDRESS__PHONE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
