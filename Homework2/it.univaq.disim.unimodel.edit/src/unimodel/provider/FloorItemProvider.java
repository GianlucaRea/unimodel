...
/**
 * This is the item provider adapter for a {@link unimodel.Floor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FloorItemProvider 
	...
	protected void addBathroomsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Floor_bathrooms_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Floor_bathrooms_feature", "_UI_Floor_type"),
				 UnimodelPackage.Literals.FLOOR__BATHROOMS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UnimodelPackage.Literals.FLOOR__ROOMS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UnimodelPackage.Literals.FLOOR__ROOMS,
				 UnimodelFactory.eINSTANCE.createRoom()));

		newChildDescriptors.add
			(createChildParameter
				(UnimodelPackage.Literals.FLOOR__ROOMS,
				 UnimodelFactory.eINSTANCE.createOffice()));

		newChildDescriptors.add
			(createChildParameter
				(UnimodelPackage.Literals.FLOOR__ROOMS,
				 UnimodelFactory.eINSTANCE.createClass()));
	}
