...
public class UnimodelPackageImpl extends EPackageImpl implements UnimodelPackage {
	 ...
	 * @generated
	 */
	public EOperation getAddress__Phone_length__DiagnosticChain_Map() {
		return addressEClass.getEOperations().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEOperation(addressEClass, ADDRESS___PHONE_LENGTH__DIAGNOSTICCHAIN_MAP);
	...
	public void initializePackageContents() {
		...
		EOperation op = initEOperation(getAddress__Postcode_length__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "postcode_length", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getAddress__Phone_length__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "phone_length", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		initEAttribute(getOffice_Phone(), ecorePackage.getEString(), "phone", null, 0, 1, Office.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation
		  (getAddress__Phone_length__DiagnosticChain_Map(),
		   source,
		   new String[] {
