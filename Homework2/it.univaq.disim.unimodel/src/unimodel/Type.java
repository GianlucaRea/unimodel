 ...
 * <!-- end-user-doc -->
 * @see unimodel.UnimodelPackage#getType()
 * @model
 * @generated
 */
public enum Type implements Enumerator {
	...
	public static Type get(int value) {
		switch (value) {
			case PROFESSOR_OFFICE_VALUE: return PROFESSOR_OFFICE;
			case PHD_ROOM_VALUE: return PHD_ROOM;
			case ADMINISTRATION_VALUE: return ADMINISTRATION;
			case SECRETARIAT_VALUE: return SECRETARIAT;
		}
		return null;
	}
