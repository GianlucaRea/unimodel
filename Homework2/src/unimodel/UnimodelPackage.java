...
public interface UnimodelPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int BUILDING_FEATURE_COUNT = NAMED_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int BUILDING___PHONE_LENGTH__DIAGNOSTICCHAIN_MAP = NAMED_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int BUILDING_OPERATION_COUNT = NAMED_OPERATION_COUNT + 1;
	 ...
	 * @ordered
	 */
	int ADDRESS___ID_NUMBER__DIAGNOSTICCHAIN_MAP = 0;
	 ...
	 * @ordered
	 */
	int ADDRESS___POSTCODE_LENGTH__DIAGNOSTICCHAIN_MAP = 1;
	...
	/**
	 * Returns the meta object for the '{@link unimodel.Building#phone_length(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Phone length</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	EOperation getBuilding__Phone_length__DiagnosticChain_Map();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EOperation BUILDING___PHONE_LENGTH__DIAGNOSTICCHAIN_MAP = eINSTANCE.getBuilding__Phone_length__DiagnosticChain_Map();
