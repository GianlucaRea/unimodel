...
public class UnimodelValidator extends EObjectValidator {
	...
	/**
	 * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Phone length' of 'Building'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final int BUILDING__PHONE_LENGTH = 1;
	 ...
	 * @generated
	 */
	public static final int ADDRESS__POSTCODE_LENGTH = 3;
	...
	public boolean validateBuilding(Building building, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(building, diagnostics, context)) return false;
		boolean result = validate_EveryMultiplicityConforms(building, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(building, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(building, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(building, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(building, diagnostics, context);
		if (result || diagnostics != null) result &= validate_UniqueID(building, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryKeyUnique(building, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(building, diagnostics, context);
		if (result || diagnostics != null) result &= validateBuilding_phone_length(building, diagnostics, context);
		return result;
	}

	/**
	 * Validates the phone_length constraint of '<em>Building</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateBuilding_phone_length(Building building, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return building.phone_length(diagnostics, context);
	}
