...
public class UnimodelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UnimodelPackage.UNIVERSITY: {
				...
				if (result == null) result = caseNamed(university);
			...
			case UnimodelPackage.BUILDING: {
				...
				if (result == null) result = caseNamed(building);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case UnimodelPackage.OFFICE: {
				...
				if (result == null) result = caseNamed(office);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UnimodelPackage.CLASS: {
				unimodel.Class class_ = (unimodel.Class)theEObject;
				T result = caseClass(class_);
				if (result == null) result = caseRoom(class_);
	 ...
	 * @generated
	 */
	public T caseClass(unimodel.Class object) {
		return null;
	}
