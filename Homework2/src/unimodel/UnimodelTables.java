 ...
 * from:
 *   /it.univaq.disim.unimodel/it.univaq.disim.unimodel/model/unimodel.ecore
 * using:
 *   /it.univaq.disim.unimodel/it.univaq.disim.unimodel/model/unimodel.genmodel
...
public class UnimodelTables extends AbstractTables
{
	...
	public static class Properties {
		...
		public static final ExecutorProperty _Address__post_code = new EcoreExecutorProperty(UnimodelPackage.Literals.ADDRESS__POST_CODE, Types._Address, 4);
		public static final ExecutorProperty _Address__state = new EcoreExecutorProperty(UnimodelPackage.Literals.ADDRESS__STATE, Types._Address, 5);
		public static final ExecutorProperty _Address__street = new EcoreExecutorProperty(UnimodelPackage.Literals.ADDRESS__STREET, Types._Address, 6);
		public static final ExecutorProperty _Address__Building__address = new ExecutorPropertyWithImplementation("Building", Types._Address, 7, new EcoreLibraryOppositeProperty(UnimodelPackage.Literals.BUILDING__ADDRESS));
		public static final ExecutorProperty _Address__Office__office_address = new ExecutorPropertyWithImplementation("Office", Types._Address, 8, new EcoreLibraryOppositeProperty(UnimodelPackage.Literals.OFFICE__OFFICE_ADDRESS));
		...
		public static final ExecutorProperty _Building__phone = new EcoreExecutorProperty(UnimodelPackage.Literals.BUILDING__PHONE, Types._Building, 4);
		public static final ExecutorProperty _Building__University__buildings = new ExecutorPropertyWithImplementation("University", Types._Building, 5, new EcoreLibraryOppositeProperty(UnimodelPackage.Literals.UNIVERSITY__BUILDINGS));
		...
		public static final ExecutorProperty _Office__type = new EcoreExecutorProperty(UnimodelPackage.Literals.OFFICE__TYPE, Types._Office, 3);
	...
	public static class FragmentProperties {
		...
		private static final ExecutorProperty /*@NonNull*/ [] _Building = {
			...
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents,
			UnimodelTables.Properties._Building__phone
		};
