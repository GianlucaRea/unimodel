 ...
 * </p>
 * <ul>
 *   <li>{@link unimodel.impl.UniversityImpl#getChancellor <em>Chancellor</em>}</li>
 *   <li>{@link unimodel.impl.UniversityImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link unimodel.impl.UniversityImpl#getBuildings <em>Buildings</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UniversityImpl extends NamedImpl implements University {
	...
	public void setChancellor(String newChancellor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnimodelPackage.UNIVERSITY__CHANCELLOR, oldChancellor, chancellor));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnimodelPackage.UNIVERSITY__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<Building> getBuildings() {
		if (buildings == null) {
			buildings = new EObjectContainmentEList<Building>(Building.class, this, UnimodelPackage.UNIVERSITY__BUILDINGS);
		}
		return buildings;
	}
